...
import { getDateSorted } from "../../utilityFunctions";
    ...
    return (
        <table className="tracks">
            ...
            {props.array.map((track) => {
                        return <tr className="track" key={track.name}>
                            <td>{array.indexOf(track)}</td>
                            ...
                            <div className="track-name">
                                ...
                                <div>
                                    ...
                                    {track.artists.map((artist) => {
                                        <h2><a href={artist.external_urls.spotify}>{artist.name}</a></h2>
                                        if(artist.length > 0 && track.artists.indexOf(artist) != (track.artists.length-1)) {
                                            return ","
                                        }
                                    })}
                                </div>
